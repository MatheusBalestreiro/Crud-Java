                ...
                <tbody>
                    <c:forEach var="despesa" items="${despesas}"> 
                        <tr>
                            ...
                            <td align="center">
                                <a class="btn btn-danger" href="#" id="deletar" title="Excluir" onclick="deletar(${despesa.idDespesa})">
                                    Excluir
                                </a>
                            </td>                        
                            <td align="center">
                                <a class="btn btn-success" href="${pageContext.request.contextPath}/DespesaCarregar?idDespesa=${despesa.idDespesa}">
                                   Alterar
                                </a>
                            </td>             
                        </tr>
...
<div align = "center">
<a class="btn btn-outline-success mb-4 mt-4" href="${pageContext.request.contextPath}/DespesaNovo">
